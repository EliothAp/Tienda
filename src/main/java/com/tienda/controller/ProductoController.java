...
public class ProductoController {
    ...
    public String guardar(@Valid Producto producto,
        ...
        redirectAttributes.addFlashAttribute("tookook",
    ...
    public String eliminar(@RequestParam Integer idProducto,
            RedirectAttributes redirectAttributes) {
        String titulo = "tookook";
        String detalle = "mensaje.eliminado";
        try {
            productoService.delete(idProducto);
        } catch (IllegalArgumentException e) {
            titulo = "error"; // ID inválido
            detalle = "categoria.error01";
        } catch (IllegalStateException e) {
            titulo = "error"; // Datos asociados
            detalle = "categoria.error02";
        } catch (Exception e) {
            titulo = "error"; // Excepción inesperada
